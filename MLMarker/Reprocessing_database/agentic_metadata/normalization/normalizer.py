...
class TermNormalizer:
    ...
    def load_ontology(self,
        ...
        self._load_custom_synonyms(graph, ontology_id)
    ...
    def load_all_ontologies(self) -> None:
        ...
        logger.info("Embedding ontologies with SapBERT for FAISS:")
        ...
        for ontology_id, filename in self.config.ontology_files.items():
            ...
            if path and path.exists():
                ...
                skipped.append(ontology_id)

        if skipped:
            logger.warning(
                "Ontology files not found (run 'python main.py setup'): %s",
                ", ".join(skipped),
            )
